...
const checkSSL = (targetUrl, detailed) => {
        ...
        try {
            ...
            const socket = tls_1.default.connect(options, () => {
                ...
                if (daysRemaining < 0) {
                    ...
                    if (grade < 'C')
                        grade = 'C'; // Downgrade to at most C if not already worse
                }
                ...
                const subject = typeof cert.subject === 'object' ? cert.subject.CN : String(cert.subject);
                ...
                if (detailed) {
                    ...
                    while (currentCert && depth < 5) {
                        chain.push({
                            subject: currentCert.subject.CN,
